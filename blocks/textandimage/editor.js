(function (wp) {
    ...
    fetch(`${window.location.origin}/wp-content/themes/bramwerink/blocks/textandimage/block.php`)
        .then(function (response) {
            return response.text();
        })
        .then(function (html) {
            // Register the block once HTML is fetched
            registerBlockType('blocks/textandimage', {
                title: __('Textandimage', 'bramwerink'),
                icon: 'smiley',
                category: 'text',
                attributes: {
                    content: {
